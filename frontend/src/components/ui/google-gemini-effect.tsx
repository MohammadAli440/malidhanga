...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-80", className)}>
      <p className=" pb-4 text-center font-spaceGrotesk text-6xl font-semibold tracking-tighter  ">
        {title || `Got Some Ideas ? Lets'Connect`}
      </p>
      <p className="mx-auto mb-10 mt-4 max-w-lg text-center font-spaceGrotesk text-xs font-normal text-neutral-400 md:text-xl">
        {description ||
          `Have a brilliant idea you're itching to bring to life?
Let's collaborate and make it happen!`}
      </p>
      <div className="flex-center h-[35vh] w-full   ">
        <div className="flex-center z-30 flex-col gap-2 p-5 text-xs font-bold text-black md:text-base ">
          <a href="mailto:gurvindermaksudra@gmail.com">
            <div className="flex-center neon group gap-2 rounded-full transition-all duration-700 ease-in-out hover:scale-110 undefined">
              <img
                alt="astrik"
                loading="lazy"
                width={20}
          ...
          >
            <img
              ...
              src="/new/cal.svg"
            />
            <p className="text-sm font-light">Schedule a call</p>
          </button>
        </div>
      </div>
      <svg
